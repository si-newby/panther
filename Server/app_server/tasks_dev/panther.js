...
class PantherXHR extends Panther
{
    ...
    ReturnTaskToServer()
    {
        ...
        // Create new XHR object
        let request = new XMLHttpRequest();
        request.open("POST", this.postURL + "?sid=" + this.sessionID);
        request.setRequestHeader("Content-Type", "application/json");
        // nrequest.setRequestHeader("Content-Encoding", "gzip"); // this is new
        ...
        request.send(JSON.stringify(this.TaskContainer)); 
